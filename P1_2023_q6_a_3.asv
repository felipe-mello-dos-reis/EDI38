...
phi_t = 0.016; % m %inferior
phi_c = 0.0125; % m %superior
N_t = 1; % Numero de barras de aco tracionadas
N_c = 1; % Numero de barras de aco comprimidas
b = 0.20; %m
h = 0.40; %m
A_st = N_t*pi*phi_t*phi_t/4;
A_sc = N_c*pi*phi_c*phi_c/4;
M_d = 15.3*1e3*1.4*1e-6; %MN*m tinha que ser dado
