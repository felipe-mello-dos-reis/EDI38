...
b = 0.20; %m
h = 0.35; %m
M_d = 0.1764; %MN*m #Majorar esforços
...
phi_t = 0.032;
d_t = c+phi_t/2;
d_c = c+phi_c/2; % Precisa inicializar em funçao de phi ou nao?
d = h-d_t;
epslon_c2 = 0; % por mil
epslon_cu = 0; % por mil
x_lim = 0;
...
% Metodo da bisseccao
M_r_max = Rcc(x_lim,sigma_cd,b,d,x_lim,n,epslon_c2,epslon_cu)*d - Rcca(x_lim,sigma_cd,b,d,x_lim,n,epslon_c2,epslon_cu) + sigmasc(x_lim,d,d_c,f_yd,epslon_c2,epslon_cu,epslon_yd)*Asc(x_lim,sigma_cd,b,d,d_c,f_yd,x_lim,n,epslon_c2,epslon_cu,epslon_yd,M_d)*(d-d_c);
    x_left = d_c;
    x_right = x_lim;
    i=0;
    f_x = 1e6;
    x_span = linspace(x_left,x_right,i_max);
    while i < i_max
        i = i+1;
    ...
    [A_s,x_m] = min(A_s_necessaria(1,:));
    x_m = x_span(x_m);
    % Rcc(x_m,sigma_cd,b,d,x_lim,n,epslon_c2,epslon_cu)
    % Rcca(x_m,sigma_cd,b,d,x_lim,n,epslon_c2,epslon_cu)
    % sigmasc(x_m,d,d_c,f_yd,epslon_c2,epslon_cu,epslon_yd)
    % Asc(x_m,sigma_cd,b,d,d_c,f_yd,x_lim,n,epslon_c2,epslon_cu,epslon_yd,M_d)
